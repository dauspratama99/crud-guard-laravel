...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 31, 2022 at 05:19 AM
...
(1, 'Pirdaus', 'admin', '$2y$10$vrPp.bK7Eol.lplRQf5TTOhOV9sQoaKpzSEz.VKtWARuEjnc7gZmK', NULL, NULL, NULL);
...
(12, '2022_03_29_025426_create_userapps_table', 1),
(13, '2022_03_30_021946_create_barang_models_table', 1),
(14, '2022_03_30_025510_create_logins_table', 1);
...
INSERT INTO `userapps` (`id`, `nama`, `no_telpon`, `alamat`, `email`, `jenis_kelamin`, `gambar`, `created_at`, `updated_at`) VALUES
(4, 'Pirdaus', '0812345678', 'Padang', '99@gmail.com', 'Laki-laki', 'Firdaus B.JPG', NULL, '2022-03-30 02:52:06');
